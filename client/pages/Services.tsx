    ...
    <div className="container py-16 md:py-24">
      ...
      <div className="mt-16 md:mt-24 space-y-16">
        <ServiceSection
          ...
          points={["Full-funnel content calendar", "Community management", "UGC + creator collaborations", "Monthly growth reporting"]}
        ...
        <ServiceSection
          ...
          points={["Rapid test sprints", "Creative and landing page iteration", "Attribution & LTV modeling", "Transparent dashboards"]}
        ...
        <ServiceSection
          ...
          points={["Technical & Core Web Vitals", "Keyword & topic clustering", "On-page + internal linking", "Link outreach"]}
        ...
        <ServiceSection
          ...
          points={["Lifecycle email & automation", "CRO & A/B testing", "Analytics & tracking architecture", "Performance reporting"]}
        ...
        <ServiceSection
          ...
          points={["Design systems & UI", "Headless CMS & integrations", "Performance & accessibility", "QA & SEO best practices"]}
...
function ServiceSection({
  ...
  return (
    <section className="grid items-center gap-8 md:grid-cols-12 md:gap-12">
      <div className={`${right ? "md:order-2 md:col-span-6" : "md:col-span-6"}`}>
        <div className="relative overflow-hidden rounded-xl border bg-gradient-to-br from-[#5170FF] to-[#5D17EB] p-[1px] shadow-sm">
          <div className="relative rounded-xl">
            <img src={image} alt="" className="h-64 w-full object-cover md:h-80" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-black/10 to-transparent" />
          </div>
        </div>
      </div>
      <div className={`${right ? "md:order-1 md:col-span-6" : "md:col-span-6"}`}>
        <p className="text-xs uppercase tracking-wider text-[#5170FF]">{eyebrow}</p>
        ...
        <div className="mt-5">
          <Button asChild className="h-10 px-5 bg-gradient-to-r from-[#5170FF] to-[#5D17EB] text-white hover:from-[#3C72FC] hover:to-[#5D17EB]">
